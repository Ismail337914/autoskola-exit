...
function App() {
  ...
  return <div id="top" className="page-shell">
    ...
    <main>
      ...
      <section id="vehicles" className="section vehicle-section"><div className="container vehicle-layout"><div className="vehicle-visual" aria-label="Apstraktni placeholder vozila">
        <div className="vehicle-card">
          <div className="vehicle-card__tag">FOTOGRAFIJA VOZILA</div>
          <div className="vehicle-silhouette" aria-hidden="true">
            <div className="vehicle-body" />
            <div className="vehicle-window" />
            <div className="vehicle-wheel wheel-left" />
            <div className="vehicle-wheel wheel-right" />
          </div>
        </div>
      </div><div><p className="section-kicker">05 / VOZILA</p><h2>SPREMNI ZA<br /><em>STVARNI PUT.</em></h2><p className="body-copy">Fotografije i detalji o vozilima bit će dodani nakon potvrde stvarnih EXIT vozila.</p><div className="placeholder-label">FOTOGRAFIJA VOZILA <span>— PODATAK ZA DOPUNU</span></div></div></div></section>
